...
import { getAuthHeaders, getCurrentUser } from '../services'
...
<template>
  <div class="flex h-screen flex-col bg-slate-100 font-sans">
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <!-- Central view -->
      <main class="flex flex-1 flex-col items-center justify-start overflow-auto bg-slate-200 p-3 gap-4 sm:p-6">
          ...
          <div class="flex w-full max-w-4xl items-center gap-4">
            ...
            <div class="relative flex-1">
              ...
              <div
                ...
                style="aspect-ratio:16/9; overflow:auto"
              >
                <h2 v-if="currentSlide?.title" class="text-lg font-bold text-slate-900">
                  {{ currentSlide.title }}
                </h2>
                <p class="whitespace-pre-line text-sm text-slate-700">{{ currentSlide?.text }}</p>
              </div>
